...
module.exports = {
    ...
    create(context) {
         ...
         * @returns {boolean} Whether or not the property is set.
         */
        function getOptionValue(option) {
            return context.options[1] ? context.options[1][option] : false;
        }

        const enabledTypes = context.options[0];
        const enforceForRenamedProperties = getOptionValue("enforceForRenamedProperties");
        ...
        function performCheck(leftNode, rightNode, reportNode) {
            /* eslint-disable */
            console.log('==================================================');
            console.dir(leftNode);
            console.log('-------------------------');
            console.dir(rightNode);
            console.log('-------------------------');
            console.dir(reportNode);
            console.log('==================================================');
            /* eslint-enable */
            if (
